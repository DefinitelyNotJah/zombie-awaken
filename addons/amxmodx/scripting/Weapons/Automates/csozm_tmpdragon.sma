...
new tmpdragon_V_MODEL[64] = "models/zm/v_tmpdragon.mdl"
new tmpdragon_P_MODEL[64] = "models/zm/p_tmpdragon.mdl"
new tmpdragon_W_MODEL[64] = "models/zm_cso/w_primarynew.mdl"
...
public plugin_init()
{
	register_plugin("[ZP] Extra: TMP Dragon", "1.0", "Crock / =) (Poprogun4ik) / LARS-DAY[BR]EAKER")
	...
	cvar_dmg_tmpdragon = register_cvar("cso_tmpdragon_dmg", "1.0")
	cvar_recoil_tmpdragon = register_cvar("cso_tmpdragon_recoil", "1.0")
	cvar_clip_tmpdragon = register_cvar("cso_tmpdragon_clip", "30")
	cvar_spd_tmpdragon = register_cvar("cso_tmpdragon_spd", "1.0")
	cvar_tmpdragon_ammo = register_cvar("cso_tmpdragon_ammo", "200")
...
public plugin_precache()
{
	...
	precache_model(tmpdragon_P_MODEL)
	precache_model(tmpdragon_W_MODEL)
	...
	precache_generic("sprites/weapon_tmpdragon_csozm.txt")
   	precache_generic("sprites/csozm/640hud69.spr")
    	precache_generic("sprites/csozm/640hud7.spr")
	
        register_clcmd("weapon_tmpdragon_csozm", "weapon_hook")	
...
public give_tmpdragon(id)
{
	...
	if( iWep2 > 0 )
	{
		...
		write_string("weapon_tmpdragon_csozm")
		write_byte(10)
		write_byte(120)
		write_byte(-1)
		write_byte(-1)
