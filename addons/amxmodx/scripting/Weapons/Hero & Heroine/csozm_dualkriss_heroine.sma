...
new dualkriss_V_MODEL[64] = "models/csozm/v_dualkriss.mdl"
new dualkriss_P_MODEL[64] = "models/csozm/p_dualkriss.mdl"
new dualkriss_W_MODEL[64] = "models/zm_cso/w_primarynew.mdl"

new const GUNSHOT_DECALS[] = { 41, 42, 43, 44, 45 }

new cvar_dmg_dualkriss, cvar_recoil_dualkriss, g_itemid_dualkriss, cvar_clip_dualkriss, cvar_spd_dualkriss, cvar_dualkriss_ammo
...
public plugin_init()
{
	...
	cvar_dmg_dualkriss = register_cvar("cso_dualkriss_dmg", "1.8")
	cvar_recoil_dualkriss = register_cvar("cso_dualkriss_recoil", "0.94")
	cvar_clip_dualkriss = register_cvar("cso_dualkriss_clip", "50")
	cvar_spd_dualkriss = register_cvar("cso_dualkriss_spd", "0.98")
	cvar_dualkriss_ammo = register_cvar("cso_dualkriss_ammo", "200")
...
public plugin_precache()
{
	...
	precache_generic("sprites/weapon_dualkriss_csozm.txt")
   	precache_generic("sprites/csozm/640hud54.spr")
    	precache_generic("sprites/csozm/640hud7.spr")
	
        register_clcmd("weapon_dualkriss_csozm", "weapon_hook")	
...
{       
	if( pPlayer && get_user_weapon(pEnt) == CSW_UMP45 && g_has_dualkriss[pEnt] )
	{
		static iAnim;
		...
		switch( iAnim )
		{
			case 10:
			{
				set_es( ES_Handle, ES_Sequence, 22 );
			}
			case 11:
			{
				set_es( ES_Handle, ES_Sequence, random_num(23, 24) );
			}
			case 12:
			{
				set_es( ES_Handle, ES_Sequence, 25 );
			}
			case 13:
			{
				set_es( ES_Handle, ES_Sequence, 26 );
			}
			case 14:
			{
				set_es( ES_Handle, ES_Sequence, random_num(27, 28) );
			}
			case 15:
			{
				set_es( ES_Handle, ES_Sequence, 29 );
			}
		}
	}
	return FMRES_IGNORED;
...
{
	register_native("give_weapon_dualkriss", "native_give_dualkriss", 1)
}
public native_give_dualkriss(id)
{
	give_dualkriss(id)
}
public give_dualkriss(id)
{
	...
	if( iWep2 > 0 )
	{
		...
		write_string("weapon_dualkriss_csozm")
		write_byte(6)
		write_byte(100)
		write_byte(-1)
		write_byte(-1)
