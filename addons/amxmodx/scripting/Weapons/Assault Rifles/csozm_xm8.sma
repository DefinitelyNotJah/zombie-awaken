...
new xm8_W_MODEL[64] = "models/zm_cso/w_primarynew.mdl"

new const GUNSHOT_DECALS[] = { 41, 42, 43, 44, 45 }

new cvar_dmg_xm8, cvar_recoil_xm8, g_itemid_xm8, cvar_clip_xm8, cvar_spd_xm8, cvar_xm8_ammo
...
public plugin_init()
{
	...
	cvar_dmg_xm8 = register_cvar("cso_xm8_dmg", "1.0")
	cvar_recoil_xm8 = register_cvar("cso_xm8_recoil", "0.98")
	cvar_clip_xm8 = register_cvar("cso_xm8_clip", "30")
	cvar_spd_xm8 = register_cvar("cso_xm8_spd", "0.92")
	cvar_xm8_ammo = register_cvar("cso_xm8_ammo", "180")
...
public plugin_precache()
{
	...
	precache_generic("sprites/weapon_xm8_csozm.txt")
   	precache_generic("sprites/csozm/640hud22.spr")
    	precache_generic("sprites/csozm/640hud7.spr")
	
        register_clcmd("weapon_xm8_csozm", "weapon_hook")	
...
{
	register_native("give_weapon_xm8", "native_give_weapon_add", 1)
}
