...
new guitar_V_MODEL[64] = "models/zm/v_guitar.mdl"
new guitar_P_MODEL[64] = "models/zm/p_guitar.mdl"
new guitar_W_MODEL[64] = "models/zm_cso/w_primarynew.mdl"
...
public plugin_init()
{
	...
	cvar_dmg_guitar = register_cvar("cso_guitar_dmg", "1.2")
	cvar_recoil_guitar = register_cvar("cso_guitar_recoil", "0.98")
	cvar_clip_guitar = register_cvar("cso_guitar_clip", "30")
	cvar_spd_guitar = register_cvar("cso_guitar_spd", "1.19")
	cvar_guitar_ammo = register_cvar("cso_guitar_ammo", "180")
...
public plugin_precache()
{
	...
	precache_generic("sprites/weapon_guitar_csozm.txt")
   	precache_generic("sprites/csozm/640hud38.spr")
    	precache_generic("sprites/csozm/640hud7.spr")
	
        register_clcmd("weapon_guitar_csozm", "weapon_hook")	
...
public give_guitar(id)
{
	...
	if( iWep2 > 0 )
	{
		...
		write_string("weapon_guitar_csozm")
		write_byte(4)
		write_byte(90)
		write_byte(-1)
		write_byte(-1)
