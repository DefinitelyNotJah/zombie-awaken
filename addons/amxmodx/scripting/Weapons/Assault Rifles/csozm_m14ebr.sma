...
new m14ebr_W_MODEL[64] = "models/zm_cso/w_primarynew.mdl"
...
public plugin_init()
{
	...
	cvar_dmg_m14ebr = register_cvar("cso_m14ebr_dmg", "1.29")
	cvar_recoil_m14ebr = register_cvar("cso_m14ebr_recoil", "0.96")
	cvar_clip_m14ebr = register_cvar("cso_m14ebr_clip", "20")
	cvar_spd_m14ebr = register_cvar("cso_m14ebr_spd", "1.03")
	cvar_m14ebr_ammo = register_cvar("cso_m14ebr_ammo", "180")
...
public plugin_precache()
{
	...
	precache_generic("sprites/weapon_m14ebr_csozm.txt")
   	precache_generic("sprites/csozm/640hud47.spr")
    	precache_generic("sprites/csozm/640hud7.spr")
	
        register_clcmd("weapon_m14ebr_csozm", "weapon_hook")	
...
public give_m14ebr(id)
{
	...
	if( iWep2 > 0 )
	{
		...
		write_string("weapon_m14ebr_csozm")
		write_byte(2)
		write_byte(90)
		write_byte(-1)
		write_byte(-1)
