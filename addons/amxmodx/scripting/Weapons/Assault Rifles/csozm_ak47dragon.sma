...
new akdragon_V_MODEL[64] = "models/zm/v_akd.mdl"
new akdragon_P_MODEL[64] = "models/zm/p_akd.mdl"
new akdragon_W_MODEL[64] = "models/zm_cso/w_primarynew.mdl"

new const GUNSHOT_DECALS[] = { 41, 42, 43, 44, 45 }

new cvar_dmg_akdragon, cvar_recoil_akdragon, g_itemid_akdragon, cvar_clip_akdragon, cvar_spd_akdragon, cvar_akdragon_ammo
...
public plugin_init()
{
	register_plugin("[ZP] Extra: AK47 Red Dragon", "1.0", "Crock / =) (Poprogun4ik) / LARS-DAY[BR]EAKER")
	...
	cvar_dmg_akdragon = register_cvar("cso_akdragon_dmg", "1.0")
	cvar_recoil_akdragon = register_cvar("cso_akdragon_recoil", "1.0")
	cvar_clip_akdragon = register_cvar("cso_akdragon_clip", "30")
	cvar_spd_akdragon = register_cvar("cso_akdragon_spd", "1.0")
	cvar_akdragon_ammo = register_cvar("cso_akdragon_ammo", "180")
...
public plugin_precache()
{
	...
	precache_generic("sprites/weapon_ak47dragon_csozm.txt")
   	precache_generic("sprites/csozm/640hud45.spr")
    	precache_generic("sprites/csozm/640hud7.spr")
	
        register_clcmd("weapon_ak47dragon_csozm", "weapon_hook")	
...
public give_akdragon(id)
{
	...
	if( iWep2 > 0 )
	{
		...
		write_string("weapon_ak47dragon_csozm")
		write_byte(2)
		write_byte(90)
		write_byte(-1)
		write_byte(-1)
