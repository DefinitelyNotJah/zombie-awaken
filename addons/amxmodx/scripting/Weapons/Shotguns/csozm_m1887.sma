...
new M1887_W_MODEL[64] = "models/zm_cso/w_primarynew.mdl"
...
public plugin_init()
{
	...
	cvar_dmg_m1887 = register_cvar("cso_m1887_dmg", "0.8")
	cvar_recoil_m1887 = register_cvar("cso_m1887_recoil", "0.55")           
	cvar_clip_m1887 = register_cvar("cso_m1887_clip", "8")
	cvar_spd_m1887 = register_cvar("cso_m1887_spd", "1.0")
	cvar_m1887_ammo = register_cvar("cso_m1887_ammo", "64")
...
public plugin_precache()
{
	...
	precache_generic("sprites/weapon_m1887_csozm.txt")
   	precache_generic("sprites/csozm/640hud34.spr")
    	precache_generic("sprites/csozm/640hud7.spr")
	
        register_clcmd("weapon_m1887_csozm", "weapon_hook")	
...
public give_m1887(id)
{
	...
	if( iWep2 > 0 )
	{
		...
		write_string("weapon_m1887_csozm")
		write_byte(5)
		write_byte(32)
		write_byte(-1)
		write_byte(-1)
