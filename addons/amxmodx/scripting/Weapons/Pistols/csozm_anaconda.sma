...
new anaconda_V_MODEL[64] = "models/zm/v_ana.mdl"
new anaconda_P_MODEL[64] = "models/zm/p_ana.mdl"
new anaconda_W_MODEL[64] = "models/zm_cso/w_secondary.mdl"
...
public plugin_init()
{
	register_plugin("[ZP] Extra: Anaconda", "1.0", "Crock / =) (Poprogun4ik) / LARS-BLOODLIKER")
	...
	cvar_dmg_anaconda = register_cvar("cso_anaconda_dmg", "1.2")
	cvar_recoil_anaconda = register_cvar("cso_anaconda_recoil", "1.0")
	cvar_clip_anaconda = register_cvar("cso_anaconda_clip", "7")
	cvar_spd_anaconda = register_cvar("cso_anaconda_spd", "0.7")
	cvar_anaconda_ammo = register_cvar("cso_anaconda_ammo", "70")
...
public plugin_precache()
{
	...
	precache_generic("sprites/weapon_anaconda_csozm.txt")
   	precache_generic("sprites/csozm/640hud28.spr")
    	precache_generic("sprites/csozm/640hud7.spr")
	
        register_clcmd("weapon_anaconda_csozm", "weapon_hook")	
...
public give_anaconda(id)
{
	...
	if( iWep2 > 0 )
	{
		...
		write_string("weapon_anaconda_csozm")
		write_byte(8)
		write_byte(35)
		write_byte(-1)
		write_byte(-1)
