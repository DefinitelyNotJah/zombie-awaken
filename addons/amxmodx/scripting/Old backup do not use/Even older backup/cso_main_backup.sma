...
public clcmd_make_yaksha(id, level, cid)
{
	if(get_user_flags(id) & ADMIN_RCON) {
		...
		if(g_startround && !g_roundstart)
		{
			...
			infect_user(i_Target)
			fm_set_user_health(i_Target, 40000)
			check_teams()
...
public set_user_human(id)
{
	...
	{
		case 1 : bonushealth = 10
		case 2 : bonushealth = 20			
		case 3 : bonushealth = 30		
		case 4 : bonushealth = 40
		case 5 : bonushealth = 50
		case 6 : bonushealth = 55
		case 7 : bonushealth = 60
		case 8 : bonushealth = 65
		case 9 : bonushealth = 75
		case 10 : bonushealth = 80
...
public client_PreThink(id)
{
	...
	{
		case 1 : speedswiftness = 1
		case 2 : speedswiftness = 2
		case 3 : speedswiftness = 3
		case 4 : speedswiftness = 4
		case 5 : speedswiftness = 5
		case 6 : speedswiftness = 6
		case 7 : speedswiftness = 7
		case 8 : speedswiftness = 8
		case 9 : speedswiftness = 9
		case 10 : speedswiftness = 10
...
public event_TeamInfo()
{
	...
	if(fnGetHumans() > 1)
	{
		if(!task_exists(id+TASK_SPAWN) && !(round_count == 5 || round_count == 10 || round_count == 15))
		{
...
public event_round_start()
{
	...
	if(round_count == 5 || round_count == 10 || round_count == 15)
...
public start_game(player_id)
{
	...
	if(round_count == 5 || round_count == 10 || round_count == 15 && iPlayersnum >= 2)
	{
		g_nextclass[id] = yaksha
		infect_user(id)
		fm_set_user_health(id, 40000)
		check_teams()
		client_print(0, print_center, "Yaksha has appeared!")
		client_printc(0, "!g[CSO]!n !tYaksha !nis here, do your best to get rid of him.")
		g_startround = false
...
public fw_TakeDamage(victim, inflictor, attacker, Float:damage, damage_type) 
{
	...
	switch(g_levelprowess[attacker])
	{
		case 1 : damageprowess = 1.1
		case 2 : damageprowess = 1.2
		case 3 : damageprowess = 1.3
		case 4 : damageprowess = 1.4
		case 5 : damageprowess = 1.5
		case 6 : damageprowess = 1.6
		case 7 : damageprowess = 1.7
		case 8 : damageprowess = 1.8
		case 9 : damageprowess = 1.9
		case 10 : damageprowess = 2.0
	...
	if(g_zombie[attacker] && !g_zombie[victim] && !(round_count == 5 || round_count == 10 || round_count == 15))
	{
		if(fnGetHumans() != 1)
		{
			static Float:armor
		...
		else
		{
			...
			if(g_playerclass[attacker] == yaksha && g_zombie[attacker])
...
public ShowHUD(taskid)
{
	...
	if(round_count == 5 || round_count == 10 || round_count == 15)
	{
		...
		show_dhudmessage(id, "[%s%d] ZB ( %i ) HM [%s%d]^nROUND^nEliminate Yaksha", g_ZBScore >= 10 ? "" : "0", g_ZBScore, round_count, g_HMScore >= 10 ? "" : "0", g_HMScore);	
	}
	else
	{
		set_dhudmessage(random(255), random(255), random(255), -1.0, 0.0, 0, 6.0, 1.1, 0.0, 0.0);
	...
	if(g_zombie[id])
	{
		set_dhudmessage(255, 0, 0, -1.0, 0.9, 0, 6.0, 1.0)
		if(g_playerclass[id] == yaksha)
...
public infect_user(id)
{
	...
	switch(g_levelhealth[id])
	{
		case 1 : bonushealth = 100
		case 2 : bonushealth = 200		
		case 3 : bonushealth = 300		
		case 4 : bonushealth = 400
		case 5 : bonushealth = 500
		case 6 : bonushealth = 600
		case 7 : bonushealth = 700
		case 8 : bonushealth = 800
		case 9 : bonushealth = 900
		case 10 : bonushealth = 1000
		default : bonushealth = 0
	}
