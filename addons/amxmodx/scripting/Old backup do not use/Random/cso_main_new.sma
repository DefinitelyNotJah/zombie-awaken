...
public Print_VIP_List()
{
    ...
    for (iPlayer = 1; iPlayer <= get_member_game(m_nMaxPlayers); iPlayer++)
    {
...
public ShowHUD(taskid)
{
	...
	if(!g_zombie[id])
	{
		...
		show_dhudmessage(id, "Health | %d || Levels: %d/130 || XP: %d/%d || Crystals : %d/200 || Class : Human", get_user_health(id), g_iLevel[id], g_iExp[id], MAX_LEVELS[g_iLevel[ id ]], g_iCrystal[id])
	}
	else
	{
		if(g_playerclass[id] == light)
		{
			set_dhudmessage(255, 0, 0, 0.02, 0.9, 0, 6.0, 1.0)
			show_dhudmessage(id, "Health | %d || Levels: %d/130 || XP: %d/%d || Crystals : %d/200 || Class : Light", get_user_health(id), g_iLevel[id], g_iExp[id], MAX_LEVELS[g_iLevel[ id ]], g_iCrystal[id])
		}
		else if(g_playerclass[id] == normal)
		{
			set_dhudmessage(255, 0, 0, 0.02, 0.9, 0, 6.0, 1.0)
			show_dhudmessage(id, "Health | %d || Levels: %d/130 || XP: %d/%d || Crystals : %d/200 || Class : Psycho", get_user_health(id), g_iLevel[id], g_iExp[id], MAX_LEVELS[g_iLevel[ id ]], g_iCrystal[id])
		}
		else if(g_playerclass[id] == china)
		{
			set_dhudmessage(255, 0, 0, 0.02, 0.9, 0, 6.0, 1.0)
			show_dhudmessage(id, "Health | %d || Levels: %d/130 || XP: %d/%d || Crystals : %d/200 || Class : Chinese", get_user_health(id), g_iLevel[id], g_iExp[id], MAX_LEVELS[g_iLevel[ id ]], g_iCrystal[id])
		}
		else if(g_playerclass[id] == voodoo)
		{
			set_dhudmessage(255, 0, 0, 0.02, 0.9, 0, 6.0, 1.0)
			show_dhudmessage(id, "Health | %d || Levels: %d/130 || XP: %d/%d || Crystals : %d/200 || Class : Voodoo", get_user_health(id), g_iLevel[id], g_iExp[id], MAX_LEVELS[g_iLevel[ id ]], g_iCrystal[id])
		}
		else if(g_playerclass[id] == deimos)
		{
			set_dhudmessage(255, 0, 0, 0.02, 0.9, 0, 6.0, 1.0)
			show_dhudmessage(id, "Health | %d || Levels: %d/130 || XP: %d/%d || Crystals : %d/200 || Class : Deimos", get_user_health(id), g_iLevel[id], g_iExp[id], MAX_LEVELS[g_iLevel[ id ]], g_iCrystal[id])
		}
	}	
}
/* Menu */
