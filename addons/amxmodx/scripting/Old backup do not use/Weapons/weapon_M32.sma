...
new const GRENADE_MODEL[] = "models/xx/s_m79.mdl"
new in_zoom[33]
new g_reload[33]
// Sprites
...
new m32_W_MODEL[64] = "models/zm_cso/w_primarynew.mdl"
...
{
	register_native("give_weapon_m32", "native_give_weapon", 1)
}
		...
		if(equal(classname, "m32_grenade"))
		{
			...
			while((a = find_ent_in_sphere(a,originF,300.0)) != 0) {
				if( a!=owner&& a!=ptr&&pev(a,pev_takedamage)!=DAMAGE_NO)
					 ExecuteHamB( Ham_TakeDamage, a , 0,owner,  get_pcvar_float(cvar_dmg), DMG_BULLET )
