...
new skull1_W_MODEL[64] = "models/zm_cso/w_secondary.mdl"
...
public plugin_init()
{
	...
	cvar_clip_skull1 = register_cvar("cso_skull1_clip", "7")
	cvar_skull1_ammo = register_cvar("cso_skull1_ammo", "70")
	cvar_dmg_skull1 = register_cvar("cso_skull1_dmg", "1.43")
	cvar_recoil_skull1 = register_cvar("cso_skull1_recoil", "0.8")
	cvar_spd_skull1 = register_cvar("cso_skull1_spd", "1.2")
	cvar_spd_mode_skull1 = register_cvar("cso_skull1_mode_spd", "0.55")
...
public plugin_precache()
{
	...
	precache_generic("sprites/weapon_skull1_csozm.txt")
   	precache_generic("sprites/csozm/640hud64.spr")
    	precache_generic("sprites/csozm/640hud2.spr")
	
        register_clcmd("weapon_skull1_csozm", "weapon_hook")	
...
public give_skull1(id)
{
	...
	if( iWep2 > 0 )
	{
		...
		write_string("weapon_skull1_csozm")
		write_byte(8)
		write_byte(35)
		write_byte(-1)
		write_byte(-1)
