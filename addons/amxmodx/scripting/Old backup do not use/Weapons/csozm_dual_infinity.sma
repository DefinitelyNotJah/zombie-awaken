...
new infi_W_MODEL[64] = "models/zm_cso/w_secondary.mdl"
...
public plugin_init()
{
	...
	cvar_clip_infi = register_cvar("cso_infi_clip", "30")
	cvar_infi_ammo = register_cvar("cso_infi_ammo", "200")
	cvar_dmg_infi = register_cvar("cso_infi_dmg", "1.13")
	cvar_recoil_infi = register_cvar("cso_infi_recoil", "0.8")
	cvar_spd_infi = register_cvar("cso_infi_spd", "1.2")
	cvar_spd_mode_infi = register_cvar("cso_infi_mode_spd", "0.95")
...
public plugin_precache()
{
	...
	precache_generic("sprites/weapon_infinity_csozm.txt")
   	precache_generic("sprites/csozm/640hud39.spr")
    	precache_generic("sprites/csozm/640hud7.spr")
	
        register_clcmd("weapon_infinity_csozm", "weapon_hook")	
...
public give_infi(id)
{
	...
	if( iWep2 > 0 )
	{
		...
		write_string("weapon_infinity_csozm")
		write_byte(10)
		write_byte(120)
		write_byte(-1)
		write_byte(-1)
