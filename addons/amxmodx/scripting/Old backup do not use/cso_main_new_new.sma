...
public clcmd_set_user_level(id, level, cid)
{
	...
	g_levelpoints[i_Target] = str_to_num(s_Amount)
...
public end_buff(id)
{
	client_printc(id, "!g[CSO]!n Your holly buff has worn out.")
	g_buffed[id] = false
}
// Holy Bomb
public CreateBurnEntity(victim, attacker)
{
	...
	set_task(get_pcvar_float(pcvar_burn_delay), "Burn", victim+TASKID_REMOVE_BURN, params, sizeof params, "b")
